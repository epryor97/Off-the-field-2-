...
<div class="w3-quarter">
  ...
  <img src="GabyHeadshot.jpg" width:"200" height="200"
       <p><h6> Gaby is a graduate Indiana University and the Indiana University School of Law. 
<p>Being an attorney and a collegiate athelte, makes her an asset to Saaed & Little LLP.
<p>She has worked with athlete victims inside and outside of a  courtroom assiting in receiving justice for her clients. She goes above and beyond by supporting the victims, mediating between law enforcement, the prosecutors, the defense councel; and meeting every single need of the victims. </p><h6>
</div>
...
<p> She has given young girls the oppertunity to play, which is something they may have never have gotten to experience, if it hadn't been for her.
...
<h4><div class="indented"><h3><p style="border:3px; border-style:solid; border-color:#FF0000; padding: 1em;">  WHO, WHAT and HOW TO REPORT ABUSE : <br>
    <p><h5><p style="border:3px; border-style:solid; border-color:#000000; padding: 1em;"> Finding out that your child has been abused is the most heartbreaking news a parent can expereince. Deciding how to pursue taking legal action is overwhelming, chaotic and stressful. It is confusing who to turn to that fully has you and your childs' best interest. <br><p/p>
    
 <p><h4> 1.DO NOT report suspected or evidence based abuse to your childs governing sport administration. 
 ...
 <p><h4> 5.DO NOT allow your childs sport to appoint you with THEIR LAWYER.
 <p><h4>6. DO NOT speak to any HR personell without an attorney YOU chose; present.
 <p><h4>7. DO NOT notify your HR club director without an attorney present.
    
    <p>1. DO : Report to your parents or a trusting adult.
    <p>2. DO : Report to a police station that is unaffiliated with club/univeristy.
    <p>3. DO : Report to Childrens Services.
    <p>4. DO :Contact a lawyer who is NOT affiliated with university, or has any financial ties to the sports club (boosters, scholarships, ect.) </p> 
...
<div class="indented"><h2><p style="border:3px;border-style:solid;border color:#000000;padding:1em.">
  ...
  <p><center> Parents, listen up! These are signs, advice and behaviors to look out for that YOU need to think about :
      ...
      <p><center>You would sum up as the coach as 'too friendly', but "they're 'harmless."
          
      <p><center>You notice that the coach is routinely playing games or making bets with your child.
          
      <p><center> The coach makes comments about your childs body looking "good" in this sports equipment or this sports outfit.
          
      <p><center>The coach wanting to drive your children places without you (pick them up, take them to practice.)
      ...
      <p><center>****Watch for tight niched relationships/ social dynmaics between coaches and parents/the community. 
      <p> The coaches are grooming parents around them to make themselves look like the "good guy" so that IF they get cuaght, they need people to beleive they are good people. ****
          
      <p>Coaches wanting to attend your childs other sports events; if theyre involved.
          
      <p><center> Coach drinks heavily with parents. 
          
      <p><center>Gift giving.
          
      <p><center> Everyone knows he/she(the coach) can be innapropriate but they are just "immature."
          
      <p><center> You start noticing that there is always one family that seems to always have coach at their house on the weekends and have him/her around; during non-practice hours. 
          <p>(The abuser is getting close to one family so they have their protection once they abuse another child. Since he/she is not abusing their child, they will not beleive the vctim since he "didnt touch their child so he couldnt have possibly done it."
          
    <li><center> **The coach never goes on dates, has a social life or has friends, but is very close to atheltes and parents** 
    ...
    <div class="indented"> <h3><p style="border:3px; border-style:solid; border-color:#FF0000; padding: 1em;"> OFF THE FIELD RED FLAGS FOR PARENTS </h3><p>
        ...
        <p><center>They often take on the overly friendly "hero" role that is dramatic and charasmatic. Overtime, they are shaping an "innocent" personality and maniplating their true intentions.
...
<div class="w3-row-padding w3-center w3-padding-64" id="Steps to take when your child has been abused">
     <div class="indented"> <h3><p style="border:3px; border-style:solid; border-color:#FF0000; padding: 1em;"> REAL FACTS :</h3><p>
    <hr>
    <p>
    <div class="w3-third w3-margin-bottom">
      <ul class="w3-ul w3-border w3-hover-shadow">
        <li class="w3-theme">
          <p class="w3-xlarge">DID YOU KNOW? NOW YOU KNOW</p>
        </li>
        ...
        <li class="w3-padding-16"><b>10</b> "In other cases, the coverage is only available by tapping into custom programs for larger governing and sanctioning bodies that have significant negotiating power." -SAFESPORT.GOV</li>
    ...
    <div class="w3-third w3-margin-right">
      <ul class="w3-ul w3-border w3-hover-shadow">
        <li class="w3-theme-l6">
          <p class="w3-xlarge">DID YOU KNOW?</p>
        </li>
        <li class="w3-padding-16"><b>The community/team will most likely not belive you</b> Unfortunatley, this is a fact. The aftermath is detrimental and saddening. I will add some resources that can be of help. </li>
        ...
        <li class="w3-padding-16"><b>25</b> The aftermath of abuse takes many forms: Victim blame, shame, emotional distraught, community in support of the perp, rather than the victim.</li>
        <li class="w3-padding-16"><b>Class Action Sports Laywers </b> These people are the ones who truly have your childs best interest in fighting all of the monsters. They will square up witht the sports lawyers, and their molestation polocies and fight for right to be done for your child.I will list two contacts that you should contact if you ever suspect abuse/nelgect/criminal investigation due diligence procedures</li>
        <li class="w3-padding-16">
...
<div class="w3-container w3-padding-64 w3-theme-l7" id="contact">
  <div class="w3-row">
    ...
    <div class="w3-padding-16"><span class="w3-xlarge w3-border-teal w3-bottombar"></span></div>
      <h3><Right>NEVER SPEAK TO LAW ENFORCEMENT WITHOUT AN ATTORNEY PRESENT</h3><Right>
